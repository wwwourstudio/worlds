  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-12">
      <PageHeader
        ...
        description="Connect physical devices to your worlds for immersive presence."
      />
      <div className="border border-white/10 p-12">
        ...
        <p className="font-light text-white/40 max-w-lg leading-relaxed">
          This section is under active development. The Hardware Integration feature will be available in an upcoming release.
        </p>
      </div>
    </div>
  );
