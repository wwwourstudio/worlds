  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-12">
      <PageHeader
        ...
        description="Compare performance, economics, and evolution across multiple worlds."
      />
      <div className="border border-white/10 p-12">
        ...
        <p className="font-light text-white/40 max-w-lg leading-relaxed">
          This section is under active development. The World Comparison feature will be available in an upcoming release.
        </p>
      </div>
    </div>
  );
